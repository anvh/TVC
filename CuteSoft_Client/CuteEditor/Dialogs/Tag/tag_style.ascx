...
var OxOb581=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOb581[1],true)[OxOb581[0]]=function (){if(event[OxOb581[2]]){alert(element[OxOb581[3]].cssText);} ;} ;
</script>
